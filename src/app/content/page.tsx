      ...
      <div className='bg-gradient-to-t from-sky-300 to-green-100 min-h-screen'>
        ...
        <div className='py-8'>
          <div className='flex justify-center mb-6'>
            <span className='text-2xl text-black font-bold'>Danh sách</span>
          </div>
          <div className='grid grid-cols-2 gap-4 items-start justify-center text-center max-w-2xl mx-auto'>
            <div className='grid grid-cols-2 border border-solid border-black rounded-lg bg-amber-50'>
              <div>
                <p className='p-4 font-semibold text-black'>Tên</p>
              ...
              <div>
                <p className='p-4 font-semibold text-black'>Vai trò</p>
            ...
            <div>
              <p className='font-semibold text-black border border-black border-solid rounded-lg bg-green-50'>Hình ảnh minh hoạ</p>
